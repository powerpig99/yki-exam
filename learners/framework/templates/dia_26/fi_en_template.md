#### dia_26 — Calling plumber about blocked drain
**Learner role:** B
...
- **B**: <!-- LEARNER: greet, introduce self, explain your kitchen drain is completely blocked and water won't go down at all since yesterday evening -->
- **A**: Okei, kuulostaa tukokselta. Ootko kokeillut imukuppia tai mitään puhdistusainetta?
- **B**: <!-- LEARNER: say you tried a plunger and drain cleaner but nothing helped, the water just sits in the sink -->
...
- **B**: <!-- LEARNER: say tomorrow morning works, ask how long the visit will take and how much it costs -->
...
- **B**: <!-- LEARNER: ask if the price includes VAT, and ask about the kotitalousvähennys -->
...
- **B**: <!-- LEARNER: say that's good to know, confirm the appointment for tomorrow at 10, give your address -->
